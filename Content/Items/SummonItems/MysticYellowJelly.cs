...
namespace LaziestNPC.Content.Items.SummonItems
{
    public class MysticYellowJelly : ModItem
    {
        ...
        public override bool CanUseItem(Player player) => !NPC.AnyNPCs(NPCID.TownSlimeYellow);
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                NPC.NewNPC(player.GetSource_ItemUse(Item), (int)Pos.X, (int)Pos.Y, NPCID.BoundTownSlimeYellow);
            }
            return true;
        }
